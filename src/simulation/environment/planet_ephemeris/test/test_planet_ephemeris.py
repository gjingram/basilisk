...
def fswModuleTestFunction(show_plots, setRAN, setDEC, setLST, setRate):
    ...
    moduleConfig.ModelTag = 'planet_ephemeris'
    ...
    for planet in planetNames:
        ...
        if planet != FinalPlanetMessage.PlanetName:
            testFailCount += 1
            testMessages.append("FAILED: planet_ephemeris() didn't set the desired plane name " + planet)
