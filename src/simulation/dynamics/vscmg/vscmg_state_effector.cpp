...
#include "vscmg_state_effector.h"
...
{
    //! - Find number of vscmg and number of vscmg with jitter
...
void VSCMGStateEffector::updateEffectorMassProps(double integTime)
{
    ...
    // - Need to divide out the total mass of the vscmg from rCB_B and rPrimeCB_B
...
void VSCMGStateEffector::SelfInit()
{
	...
	//! - Clear out any currently firing vscmg and re-init cmd array
	NewVSCMGCmds.clear();
...
/*! This method is used to connect the input command message to the vscmg.
...
void VSCMGStateEffector::WriteOutputMessages(uint64_t CurrentClock)
{
	...
	// Write this message once for all vscmg
...
/*! This method is used to read the incoming command message and set the
 associated command structure for operating the vscmg.
 @return void
 */
