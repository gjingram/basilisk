...
#include <Eigen/Dense>
#include "utilities/avs_eigen_mrp.h"
#include "dynamics/framework/dyn_param_manager.h"
...
public:
    ...
    Eigen::Vector3d r_BP_P;                //!< position vector of the spacecraft mody frame origin B relative to the primary spacecraft body frame P.  This is used in the spacecraft_dynamics module where multiple spacecraft hubs can be a single spacecraft
